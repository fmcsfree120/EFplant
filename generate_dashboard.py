...
var CACHE_EPOCH = 'action-alarm-exemption-20260806-1';
...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('./service-worker.js?v=action-alarm-exemption-20260806-1', {updateViaCache:'none'}).catch(function(){});
}
</script>
</body>
</html>
