...
var CACHE_EPOCH = 'alarm-filter-ion-towers-20260805-1';
...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('./service-worker.js?v=alarm-filter-ion-towers-20260805-1', {updateViaCache:'none'}).catch(function(){});
}
</script>
</body>
</html>
