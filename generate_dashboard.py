...
var CACHE_EPOCH = 'action-alarm-fuzzy-match-20260806-2';
...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('./service-worker.js?v=action-alarm-fuzzy-match-20260806-2', {updateViaCache:'none'}).catch(function(){});
}
</script>
</body>
</html>
